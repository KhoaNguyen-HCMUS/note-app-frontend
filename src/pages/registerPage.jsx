      ...
      <div className='max-w-md w-full'>
        <div className='bg-white rounded-lg shadow-xl p-8'>
          ...
          <form onSubmit={handleRegister} className='space-y-6'>
            ...
            <button
              type='submit'
              className='w-full bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 flex items-center justify-center gap-2 transition-colors'
            >
              <FaUserPlus />
              Register
            </button>
